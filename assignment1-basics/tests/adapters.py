...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    model = MultiHeadAttention(d_model, num_heads, theta, max_seq_len)
    model.q_proj.weight.data = q_proj_weight
    model.k_proj.weight.data = k_proj_weight
    model.v_proj.weight.data = v_proj_weight
    model.output_proj.weight.data = o_proj_weight
...
def run_get_batch(
    ...
    """
    return train.get_batch(dataset, batch_size, context_length, device)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    return train.gradient_clipping(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return train.lr_cosine_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
